...
| Time sync UI (§8.11), notifications (§8.6/§8.4 nudges) | 🟡 | Time `…0019` write + probe done (pushed on pairing, dev re-push tool, 0x02 surfaced); pre-session dock notification pending (notifications milestone). |
